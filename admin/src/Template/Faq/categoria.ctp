<script type="text/javascript">
    var idCategoriaPergunta = <?=$id?>;
</script>
<?= $this->Html->script('controller/faq.categoria.js', ['block' => 'scriptBottom']) ?>
<div class="content">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <?= $this->Form->textarea("descricao", ["id" => "descricao", "class" => "form-control", "rows" => 3, "maxlength" => 320]) ?>
                                        <span class="material-input"></span>
                                    </div>
                                </div>
                            </div>
