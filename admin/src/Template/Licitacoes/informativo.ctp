            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                            ...
                            <?php if ($id > 0) :?>
                                <button type="button" onclick="window.location='<?= $this->Url->build(['action' => 'informativo', 0, '?' => ['idLicitacao' => $licitacao->id]]) ?>'" class="btn btn-warning pull-right">Novo</button>
                            <?php endif; ?>
                            <button type="reset" class="btn btn-default pull-right">Limpar</button>
                            <button type="button" onclick="window.location='<?= $this->Url->build(['action' => 'informativos', $licitacao->id]) ?>'" class="btn btn-info pull-right">Voltar</button>
