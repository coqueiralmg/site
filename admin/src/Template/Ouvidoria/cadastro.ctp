                            ...
                            <div class="row">
                                ...
                                <div id="panel_novo_geral" style="display: none">
                                    <div class="col-md-8">
                                        <div class="form-group label-control">
                                            ...
                                            <?= $this->Form->text("gr-nome", ["id" => "nome", "class" => "form-control", "maxlength" => 80]) ?>
                                            <span class="material-input"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group label-control">
                                            ...
                                            <?= $this->Form->text("gr-email", ["id" => "email", "class" => "form-control", "maxlength" => 50]) ?>
                                            <span class="material-input"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group label-control">
                                            ...
                                            <?= $this->Form->text("gr-telefone", ["id" => "telefone", "class" => "form-control", "maxlength" => 15]) ?>
                                            <span class="material-input"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group label-control">
                                            ...
                                            <?= $this->Form->text("gr-endereco", ["id" => "endereco", "class" => "form-control", "maxlength" => 150]) ?>
                                            <span class="material-input"></span>
                                        </div>
                                    </div>
                                </div>
                                <div id="panel_novo_iluminacao" style="display: none">
                                    <div class="col-md-8">
                                        <div class="form-group label-control">
                                            <?= $this->Form->label("nome", "Nome") ?>
                                            <?= $this->Form->text("ip-nome", ["id" => "nome", "class" => "form-control", "maxlength" => 80]) ?>
                                            <span class="material-input"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group label-control">
                                            <?= $this->Form->label("email", "E-mail") ?>
                                            <?= $this->Form->text("ip-email", ["id" => "email", "class" => "form-control", "maxlength" => 50]) ?>
                                            <span class="material-input"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group label-control">
                                            <?= $this->Form->label("telefone", "Telefone") ?>
                                            <?= $this->Form->text("ip-telefone", ["id" => "telefone", "class" => "form-control", "maxlength" => 15]) ?>
                                            <span class="material-input"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="form-group label-control">
                                            ...
                                            <?= $this->Form->text("ip-endereco", ["id" => "endereco", "class" => "form-control", "maxlength" => 150]) ?>
                                            <span class="material-input"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group label-control">
                                            ...
                                            <?= $this->Form->text("ip-numero", ["id" => "numero", "class" => "form-control", "maxlength" => 15]) ?>
                                            <span class="material-input"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group label-control">
                                            ...
                                            <?= $this->Form->text("ip-complemento", ["id" => "complemento", "class" => "form-control", "maxlength" => 15]) ?>
                                            <span class="material-input"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group label-control">
                                            ...
                                            <?= $this->Form->text("ip-bairro", ["id" => "bairro", "class" => "form-control", "maxlength" => 50]) ?>
                                            <span class="material-input"></span>
                                        </div>
                                    </div>
                                </div>
