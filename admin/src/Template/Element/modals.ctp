...
<!--Relacionamento de F.A.Q. -->
<div class="modal fade" id="modal_relacionamento_faq" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">
                ...
                <h4 class="modal-title">Buscar Pergunta a Relacionar</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group label-control">
                            <?= $this->Form->label("titulo", "Pergunta") ?>
                            <?= $this->Form->text("titulo", ["id" => "titulo", "class" => "form-control"]) ?>
                            <span class="material-input"></span>
                        </div>
                    </div>
                        ...
                        <div class="card-content table-responsive">
                            ...
                            <table id="tabela" class="table">
                                ...
                                <tbody id="pivot" style="display: none">
                                    ...
                                    <tr colspan="3">
                                        <td>
                                            <p>Dados não encontrados. Verifique se a questão realmente existe ou está cadastrada no sistema.</p>
                                        </td>
                                    </tr>
                                </tbody>
                                <tbody id="data">
