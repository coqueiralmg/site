<?php
$opcao_paginacao_number = ['tag' => 'li', 'separator' => '', 'currentTag' => 'a', 'modulus' => Cake\Core\Configure::read('Pagination.modulus')];
$opcao_paginacao_extra = ['tag' => 'li', 'disabledTag' => 'a'];

if(!isset($limit_pagination))
{
    $limit_pagination = Cake\Core\Configure::read('Pagination.limit');
}
                ...
                <div class="col-sm-7 text-right">
                    <div class="dataTables_paginate paging_full_numbers" id="datatables_paginate">
                        <ul class="pagination pagination-success" style="margin: 0">
                            <?php if(($qtd_total / $limit_pagination) > Cake\Core\Configure::read('Pagination.visiblePages')): ?>
