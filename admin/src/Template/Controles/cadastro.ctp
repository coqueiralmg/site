                    ...
                    <div class="card-content">
                        <form>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group label-control">
                                        <label>Ícone (O ícone é do Font Awesome. Para ver a lista de ícones, <a href="http://fontawesome.io/icons/" target="_blank">clique aqui</a>)</label>
