 ...
 */
class SenderTask extends Shell
{
    /**
    ...
    {
        Log::notice('Date: ' . date('d/m/Y H:i:s') .  '; From: ' . $headMail["from"] . '; To: ' . json_encode($headMail["to"]) . '; IP: localhost(shell); Assunto:' . $headMail["subject"], ['mail']);
    }
}