...
<section id="about-us">
        <div class="container">
            <div class="center wow fadeInDown">
                <h2>História de Coqueiral</h2>
                <p class="lead">Conheça mais a história da nossa cidade</p>
            </div>
                ...
                <div id="carousel-slider" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <?= $this->Html->image('slide/slider_historico1.jpg', ['class' => 'img-responsive', 'alt' => 'Torre da igreja matriz de Coqueiral']); ?>
                        </div>
                        <div class="item">
                            <?= $this->Html->image('slide/slider_historico2.jpg', ['class' => 'img-responsive', 'alt' => 'Igreja no Distrito de Frei Eustáquio']); ?>
                        </div>
                        <div class="item">
                            <?= $this->Html->image('slide/slider_historico3.jpg', ['class' => 'img-responsive', 'alt' => 'Primeiras fotos de Coqueiral no começo do século XX, onde hoje fica a Praça 7 de Setembro']); ?>
                        </div>
                        <div class="item">
                            <?= $this->Html->image('slide/slider_historico4.jpg', ['class' => 'img-responsive', 'alt' => 'Inauguração do Cruzeiro na Praça 7 de Setembro']); ?>
                        </div>
                        <div class="item">
                            <?= $this->Html->image('slide/slider_historico5.jpg', ['class' => 'img-responsive', 'alt' => 'Vista aérea da cidade']); ?>
                        </div>
                    </div>
            ...
            <section id="recent-works">
                <div class="container">
                    <div class="center wow fadeInDown">
                        ...
                        <p class="lead">A história da cidade através das fotos.</p>
                    </div>
